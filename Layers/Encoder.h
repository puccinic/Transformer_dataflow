...
)
{
	...
	hls::stream<hls::vector<T, token_length>, sequence_length> input_copy3("input_copy3");
	hls::stream<hls::vector<T, token_length>, sequence_length> input_copy4("input_copy4");
	...
	hls::stream<hls::vector<T, token_length>, sequence_length> norm_result("norm_res");
	hls::stream<hls::vector<T, token_length>, sequence_length> norm_result_copy1("norm_res_copy1");
	hls::stream<hls::vector<T, token_length>, sequence_length> norm_result_copy2("norm_res_copy2");
